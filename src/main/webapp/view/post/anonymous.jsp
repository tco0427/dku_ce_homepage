...
<body>
	...
	<div class="all">
		...
		<div>
			<div class="main">
				<div class="postName">Anonymous</div>
				<br>
				<div class="postDetail">단국대학교 컴퓨터공학과 학생들이 익명으로 이용할 수 있는 게시판입니다.</div>
				...
				<table class="type07">
					...
					<tr>
						<td id="firstTd">python3말고 2쓰면 혼나나요?ㅜ</td>
						<td id="second">익명의회원님</td>
						<td id="third">2021-04-17</td>
					</tr>
